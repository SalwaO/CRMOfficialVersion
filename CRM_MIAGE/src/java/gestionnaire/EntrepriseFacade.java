...
public class EntrepriseFacade extends AbstractFacade<Entreprise> {
    ...
    public void creerEntreprisesDeTest2() {
    ...
    public Entreprise ajouterEntreprise(String nomEnt, String adresseEnt, String cd, String ville, String description) {
        Entreprise e = new Entreprise(nomEnt, adresseEnt, cd, ville, description );
        em.persist(e);
        return e;
    }
